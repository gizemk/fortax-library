...
sys%inctax%pa=116.057692307692_dp
...
sys%inctax%bands(1)=44.6153846153846_dp
sys%inctax%bands(2)=669.230769230769_dp
...
sys%natins%c2floor=92.7900000000000_dp
sys%natins%c2rate=2.30000000000000_dp
...
sys%natins%bands(1)=105.000000000000_dp
sys%natins%bands(2)=770.000000000000_dp
...
sys%natins%c4bands(1)=104.520000000000_dp
sys%natins%c4bands(2)=770.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=12.5500000000000_dp
sys%chben%kid1xtr=6.25000000000000_dp
...
sys%ctc%kid=40.0961538461538_dp
 
!wtc
sys%wtc%Basic=34.6153846153846_dp
sys%wtc%CouLP=68.6538461538462_dp
sys%wtc%FT=14.1346153846154_dp
...
sys%incsup%MainCou=94.9500000000000_dp
sys%incsup%YngCou=72.3500000000000_dp
sys%incsup%MainLP=60.5000000000000_dp
sys%incsup%YngLP=47.9500000000000_dp
sys%incsup%MainSin=60.5000000000000_dp
sys%incsup%YngSin=47.9500000000000_dp
...
sys%ctax%bandD=26.0296153846154_dp
...
sys%rebatesys%MainCou=94.9500000000000_dp
sys%rebatesys%YngCou=72.3500000000000_dp
sys%rebatesys%MainLP=60.5000000000000_dp
sys%rebatesys%YngLP=47.9500000000000_dp
sys%rebatesys%MainSin=60.5000000000000_dp
sys%rebatesys%YngSin=47.9500000000000_dp
...
sys%rebatesys%PremFam=16.7500000000000_dp
...
sys%rebatesys%AddKid(1)=63.0900000000000_dp
sys%rebatesys%AddKid(2)=52.5900000000000_dp
