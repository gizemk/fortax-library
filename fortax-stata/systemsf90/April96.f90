...
sys%inctax%pa=72.4038461538461_dp
sys%inctax%mma=34.4230769230769_dp
...
sys%natins%bands(1)=61.0000000000000_dp
sys%natins%bands(2)=455.000000000000_dp
...
sys%natins%c4bands(1)=131.920000000000_dp
sys%natins%c4bands(2)=455.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=8.80000000000000_dp
sys%chben%kid1xtr=2.00000000000000_dp
...
sys%fc%adult=46.4500000000000_dp
sys%fc%ftprem=10.3000000000000_dp
sys%fc%hours1=16.0000000000000_dp
sys%fc%hours2=30.0000000000000_dp
sys%fc%thres=75.2000000000000_dp
...
sys%fc%kidcred(1)=11.7500000000000_dp
sys%fc%kidcred(2)=19.4500000000000_dp
sys%fc%kidcred(3)=24.1500000000000_dp
sys%fc%kidcred(4)=33.8000000000000_dp
...
sys%incsup%MainCou=75.2000000000000_dp
sys%incsup%YngCou=57.2000000000000_dp
sys%incsup%MainLP=47.9000000000000_dp
sys%incsup%YngLP=28.8500000000000_dp
sys%incsup%MainSin=47.9000000000000_dp
sys%incsup%YngSin=37.9000000000000_dp
sys%incsup%ValFSM=4.00000000000000_dp
...
sys%incsup%PremFam=10.5500000000000_dp
...
sys%incsup%AddKid(1)=16.4500000000000_dp
sys%incsup%AddKid(2)=24.1000000000000_dp
sys%incsup%AddKid(3)=28.8500000000000_dp
sys%incsup%AddKid(4)=37.9000000000000_dp
 
!ctax
sys%ctax%docounciltax=.true. 
sys%ctax%bandD=12.2423076923077_dp
...
sys%rebatesys%MainCou=75.2000000000000_dp
sys%rebatesys%YngCou=57.2000000000000_dp
sys%rebatesys%MainLP=47.9000000000000_dp
sys%rebatesys%YngLP=37.9000000000000_dp
sys%rebatesys%MainSin=47.9000000000000_dp
sys%rebatesys%YngSin=37.9000000000000_dp
...
sys%rebatesys%PremFam=10.5500000000000_dp
...
sys%rebatesys%AddKid(1)=16.4500000000000_dp
sys%rebatesys%AddKid(2)=24.1000000000000_dp
sys%rebatesys%AddKid(3)=28.8500000000000_dp
sys%rebatesys%AddKid(4)=37.9000000000000_dp
