...
sys%inctax%pa=83.3653846153846_dp
sys%inctax%mma=37.8846153846154_dp
...
sys%inctax%bands(1)=28.8461538461538_dp
sys%inctax%bands(2)=538.461538461538_dp
...
sys%natins%c2floor=72.5000000000000_dp
sys%natins%c2rate=6.55000000000000_dp
sys%natins%ceiling=500.000000000000_dp
...
sys%natins%bands(1)=66.0000000000000_dp
sys%natins%bands(2)=500.000000000000_dp
...
sys%natins%c4bands(1)=145.000000000000_dp
sys%natins%c4bands(2)=500.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=9.60000000000000_dp
sys%chben%kid1xtr=4.80000000000000_dp
...
sys%fc%adult=52.3000000000000_dp
sys%fc%ftprem=11.0500000000000_dp
sys%fc%hours1=16.0000000000000_dp
sys%fc%hours2=30.0000000000000_dp
sys%fc%thres=90.0000000000000_dp
...
sys%fc%kidcred(1)=19.8500000000000_dp
sys%fc%kidcred(2)=20.9000000000000_dp
sys%fc%kidcred(3)=25.9500000000000_dp
sys%fc%kidcred(4)=25.9500000000000_dp
...
sys%incsup%MainCou=80.6500000000000_dp
sys%incsup%YngCou=61.3500000000000_dp
sys%incsup%MainLP=51.4000000000000_dp
sys%incsup%YngLP=30.9500000000000_dp
sys%incsup%MainSin=51.4000000000000_dp
sys%incsup%YngSin=40.7000000000000_dp
sys%incsup%ValFSM=4.40000000000000_dp
...
sys%incsup%PremFam=13.9000000000000_dp
...
sys%incsup%AddKid(1)=24.9000000000000_dp
sys%incsup%AddKid(2)=25.9000000000000_dp
sys%incsup%AddKid(3)=30.9500000000000_dp
sys%incsup%AddKid(4)=30.9500000000000_dp
 
!ctax
sys%ctax%docounciltax=.true. 
sys%ctax%bandD=15.1380769230769_dp
...
sys%rebatesys%MainCou=80.6500000000000_dp
sys%rebatesys%YngCou=61.3500000000000_dp
sys%rebatesys%MainLP=51.4000000000000_dp
sys%rebatesys%YngLP=40.7000000000000_dp
sys%rebatesys%MainSin=51.4000000000000_dp
sys%rebatesys%YngSin=40.7000000000000_dp
...
sys%rebatesys%PremFam=13.9000000000000_dp
...
sys%rebatesys%AddKid(1)=24.9000000000000_dp
sys%rebatesys%AddKid(2)=25.9000000000000_dp
sys%rebatesys%AddKid(3)=30.9500000000000_dp
sys%rebatesys%AddKid(4)=30.9500000000000_dp
