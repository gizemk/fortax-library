...
sys%natins%c2floor=76.1000000000000_dp
sys%natins%c2rate=2.00000000000000_dp
sys%natins%ceiling=575.000000000000_dp
...
sys%natins%bands(1)=87.0000000000000_dp
sys%natins%bands(2)=575.000000000000_dp
...
sys%natins%c4bands(1)=87.2100000000000_dp
sys%natins%c4bands(2)=575.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=10.3500000000000_dp
sys%chben%kid1xtr=5.15000000000000_dp
...
sys%fc%adult=54.0000000000000_dp
sys%fc%ftprem=11.4500000000000_dp
sys%fc%hours1=16.0000000000000_dp
sys%fc%hours2=30.0000000000000_dp
sys%fc%thres=92.9000000000000_dp
...
sys%fc%kidcred(1)=26.0000000000000_dp
sys%fc%kidcred(2)=26.0000000000000_dp
sys%fc%kidcred(3)=26.7500000000000_dp
sys%fc%kidcred(4)=26.7500000000000_dp
...
sys%incsup%MainCou=83.2500000000000_dp
sys%incsup%YngCou=63.3500000000000_dp
sys%incsup%MainLP=53.0500000000000_dp
sys%incsup%YngLP=31.9500000000000_dp
sys%incsup%MainSin=53.0500000000000_dp
sys%incsup%YngSin=42.0000000000000_dp
sys%incsup%ValFSM=4.19000000000000_dp
...
sys%incsup%PremFam=14.5000000000000_dp
...
sys%incsup%AddKid(1)=31.4500000000000_dp
sys%incsup%AddKid(2)=31.4500000000000_dp
sys%incsup%AddKid(3)=32.2500000000000_dp
sys%incsup%AddKid(4)=32.2500000000000_dp
 
!ctax
sys%ctax%docounciltax=.true. 
sys%ctax%bandD=17.1255769230769_dp
...
sys%rebatesys%MainCou=83.2500000000000_dp
sys%rebatesys%YngCou=63.3500000000000_dp
sys%rebatesys%MainLP=53.0500000000000_dp
sys%rebatesys%YngLP=42.0000000000000_dp
sys%rebatesys%MainSin=53.0500000000000_dp
sys%rebatesys%YngSin=42.0000000000000_dp
...
sys%rebatesys%PremFam=14.5000000000000_dp
...
sys%rebatesys%AddKid(1)=31.4500000000000_dp
sys%rebatesys%AddKid(2)=31.4500000000000_dp
sys%rebatesys%AddKid(3)=32.2500000000000_dp
sys%rebatesys%AddKid(4)=32.2500000000000_dp
