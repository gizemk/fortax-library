...
sys%inctax%bands(1)=48.0769230769231_dp
...
sys%natins%c2floor=60.3800000000000_dp
sys%natins%c2rate=5.55000000000000_dp
sys%natins%ceiling=420.000000000000_dp
...
sys%natins%bands(1)=56.0000000000000_dp
sys%natins%bands(2)=420.000000000000_dp
...
sys%natins%c4bands(1)=121.930000000000_dp
sys%natins%c4bands(2)=420.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=8.10000000000000_dp
sys%chben%kid1xtr=1.90000000000000_dp
...
sys%fc%kidcred(1)=10.7500000000000_dp
sys%fc%kidcred(2)=17.8500000000000_dp
sys%fc%kidcred(3)=22.2000000000000_dp
sys%fc%kidcred(4)=31.0000000000000_dp
...
sys%incsup%MainCou=69.0000000000000_dp
sys%incsup%YngCou=52.4000000000000_dp
sys%incsup%MainLP=44.0000000000000_dp
sys%incsup%YngLP=26.4500000000000_dp
sys%incsup%MainSin=44.0000000000000_dp
sys%incsup%YngSin=34.8000000000000_dp
...
sys%incsup%PremFam=9.65000000000000_dp
sys%incsup%PremLP=4.90000000000000_dp
...
sys%incsup%AddKid(1)=15.0500000000000_dp
sys%incsup%AddKid(2)=22.1500000000000_dp
sys%incsup%AddKid(3)=26.4500000000000_dp
sys%incsup%AddKid(4)=34.8000000000000_dp
 
!ctax
sys%ctax%docounciltax=.true. 
sys%ctax%bandD=10.8048076923077_dp
...
sys%rebatesys%MainCou=69.0000000000000_dp
sys%rebatesys%YngCou=52.4000000000000_dp
sys%rebatesys%MainLP=44.0000000000000_dp
sys%rebatesys%YngLP=34.8000000000000_dp
sys%rebatesys%MainSin=44.0000000000000_dp
sys%rebatesys%YngSin=34.8000000000000_dp
...
sys%rebatesys%PremFam=9.65000000000000_dp
sys%rebatesys%PremLP=10.9500000000000_dp
...
sys%rebatesys%AddKid(1)=15.0500000000000_dp
sys%rebatesys%AddKid(2)=22.1500000000000_dp
sys%rebatesys%AddKid(3)=26.4500000000000_dp
sys%rebatesys%AddKid(4)=34.8000000000000_dp
