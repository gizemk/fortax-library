...
sys%inctax%pa=80.6730769230769_dp
sys%inctax%mma=36.5384615384615_dp
...
sys%inctax%bands(1)=82.6923076923077_dp
sys%inctax%bands(2)=521.153846153846_dp
...
sys%natins%c2floor=69.0000000000000_dp
sys%natins%c2rate=6.25000000000000_dp
sys%natins%ceiling=485.000000000000_dp
...
sys%natins%bands(1)=64.0000000000000_dp
sys%natins%bands(2)=485.000000000000_dp
...
sys%natins%c4bands(1)=140.600000000000_dp
sys%natins%c4bands(2)=485.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=9.30000000000000_dp
sys%chben%kid1xtr=2.15000000000000_dp
...
sys%fc%adult=48.8000000000000_dp
sys%fc%ftprem=10.8000000000000_dp
sys%fc%hours1=16.0000000000000_dp
sys%fc%hours2=30.0000000000000_dp
sys%fc%thres=79.0000000000000_dp
...
sys%fc%kidcred(1)=12.3500000000000_dp
sys%fc%kidcred(2)=20.4500000000000_dp
sys%fc%kidcred(3)=25.4000000000000_dp
sys%fc%kidcred(4)=25.4000000000000_dp
...
sys%incsup%MainCou=79.0000000000000_dp
sys%incsup%YngCou=60.1000000000000_dp
sys%incsup%MainLP=50.3500000000000_dp
sys%incsup%YngLP=30.3000000000000_dp
sys%incsup%MainSin=50.3500000000000_dp
sys%incsup%YngSin=39.8500000000000_dp
sys%incsup%ValFSM=4.25000000000000_dp
...
sys%incsup%PremFam=11.0500000000000_dp
...
sys%incsup%AddKid(1)=17.3000000000000_dp
sys%incsup%AddKid(2)=25.3500000000000_dp
sys%incsup%AddKid(3)=30.3000000000000_dp
sys%incsup%AddKid(4)=30.3000000000000_dp
 
!ctax
sys%ctax%docounciltax=.true. 
sys%ctax%bandD=14.1596153846154_dp
...
sys%rebatesys%MainCou=79.0000000000000_dp
sys%rebatesys%YngCou=60.1000000000000_dp
sys%rebatesys%MainLP=50.3500000000000_dp
sys%rebatesys%YngLP=39.8500000000000_dp
sys%rebatesys%MainSin=50.3500000000000_dp
sys%rebatesys%YngSin=39.8500000000000_dp
...
sys%rebatesys%PremFam=11.0500000000000_dp
sys%rebatesys%PremLP=11.0000000000000_dp
...
sys%rebatesys%AddKid(1)=17.3000000000000_dp
sys%rebatesys%AddKid(2)=25.3500000000000_dp
sys%rebatesys%AddKid(3)=30.3000000000000_dp
sys%rebatesys%AddKid(4)=30.3000000000000_dp
