...
allocate(sys%inctax%bands(2))
sys%inctax%bands(1)=455.769230769231_dp
sys%inctax%bands(2)=19230.7500000000_dp
allocate(sys%inctax%rates(2))
sys%inctax%rates(1)=0.250000000000000_dp
sys%inctax%rates(2)=0.400000000000000_dp
 
!natins
sys%natins%numrates=2
sys%natins%c4nrates=3
sys%natins%c2floor=55.7600000000000_dp
sys%natins%c2rate=5.15000000000000_dp
sys%natins%ceiling=390.000000000000_dp
...
sys%natins%bands(1)=52.0000000000000_dp
sys%natins%bands(2)=390.000000000000_dp
...
sys%natins%c4bands(1)=113.460000000000_dp
sys%natins%c4bands(2)=390.000000000000_dp
...
sys%fc%adult=38.3000000000000_dp
sys%fc%ftprem=0.000000000000000E+000_dp
sys%fc%hours1=24.0000000000000_dp
sys%fc%hours2=0.000000000000000E+000_dp
sys%fc%thres=62.2500000000000_dp
sys%fc%taper=0.700000000000000_dp
sys%fc%MaintDisreg=0.000000000000000E+000_dp
...
sys%fc%kidcred(1)=9.70000000000000_dp
sys%fc%kidcred(2)=16.1000000000000_dp
sys%fc%kidcred(3)=20.0500000000000_dp
sys%fc%kidcred(4)=27.9500000000000_dp
...
sys%incsup%YngCou=47.3000000000000_dp
sys%incsup%MainLP=39.6500000000000_dp
sys%incsup%YngLP=23.6500000000000_dp
sys%incsup%MainSin=39.6500000000000_dp
sys%incsup%YngSin=31.1500000000000_dp
...
sys%incsup%PremFam=7.95000000000000_dp
sys%incsup%PremLP=4.45000000000000_dp
sys%incsup%hours=24.0000000000000_dp
...
sys%incsup%AddKid(1)=13.6000000000000_dp
sys%incsup%AddKid(2)=20.0000000000000_dp
sys%incsup%AddKid(3)=23.9000000000000_dp
sys%incsup%AddKid(4)=31.4000000000000_dp
...
sys%rebatesys%MainCou=62.2500000000000_dp
sys%rebatesys%YngCou=47.3000000000000_dp
sys%rebatesys%MainLP=39.6500000000000_dp
sys%rebatesys%YngLP=31.1500000000000_dp
sys%rebatesys%MainSin=39.6500000000000_dp
sys%rebatesys%YngSin=31.1500000000000_dp
...
sys%rebatesys%AddKid(1)=13.6000000000000_dp
sys%rebatesys%AddKid(2)=20.0000000000000_dp
