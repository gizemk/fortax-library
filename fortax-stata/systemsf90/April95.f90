...
sys%inctax%pa=67.7884615384615_dp
...
sys%inctax%bands(1)=61.5384615384615_dp
sys%inctax%bands(2)=467.307692307692_dp
...
sys%natins%c2floor=62.6900000000000_dp
sys%natins%c2rate=5.75000000000000_dp
sys%natins%ceiling=440.000000000000_dp
...
sys%natins%bands(1)=58.0000000000000_dp
sys%natins%bands(2)=440.000000000000_dp
...
sys%natins%c4bands(1)=127.690000000000_dp
sys%natins%c4bands(2)=440.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=8.45000000000000_dp
sys%chben%kid1xtr=1.95000000000000_dp
sys%chben%opf=6.30000000000000_dp
...
sys%fc%kidcred(1)=11.4000000000000_dp
sys%fc%kidcred(2)=18.9000000000000_dp
sys%fc%kidcred(3)=23.4500000000000_dp
sys%fc%kidcred(4)=32.8000000000000_dp
...
sys%incsup%MainCou=73.0000000000000_dp
sys%incsup%YngCou=55.5500000000000_dp
sys%incsup%MainLP=46.5000000000000_dp
sys%incsup%YngLP=28.0000000000000_dp
sys%incsup%MainSin=46.5000000000000_dp
sys%incsup%YngSin=36.8000000000000_dp
sys%incsup%ValFSM=3.85000000000000_dp
...
sys%incsup%PremFam=10.2500000000000_dp
sys%incsup%PremLP=5.20000000000000_dp
...
sys%incsup%AddKid(1)=15.9500000000000_dp
sys%incsup%AddKid(2)=23.4000000000000_dp
sys%incsup%AddKid(3)=28.0000000000000_dp
sys%incsup%AddKid(4)=36.8000000000000_dp
 
!ctax
sys%ctax%docounciltax=.true. 
sys%ctax%bandD=11.5000000000000_dp
...
sys%rebatesys%MainCou=73.0000000000000_dp
sys%rebatesys%YngCou=55.5500000000000_dp
sys%rebatesys%MainLP=46.5000000000000_dp
sys%rebatesys%YngLP=36.8000000000000_dp
sys%rebatesys%MainSin=46.5000000000000_dp
sys%rebatesys%YngSin=36.8000000000000_dp
...
sys%rebatesys%PremFam=10.2500000000000_dp
sys%rebatesys%PremLP=11.5000000000000_dp
...
sys%rebatesys%MaxCC1=40.0000000000000_dp
...
sys%rebatesys%AddKid(1)=15.9500000000000_dp
sys%rebatesys%AddKid(2)=23.4000000000000_dp
sys%rebatesys%AddKid(3)=28.0000000000000_dp
sys%rebatesys%AddKid(4)=36.8000000000000_dp
