...
sys%inctax%pa=91.2500000000000_dp
...
sys%inctax%bands(1)=38.8461538461538_dp
sys%inctax%bands(2)=603.846153846154_dp
...
sys%natins%c2floor=81.0500000000000_dp
sys%natins%c2rate=2.05000000000000_dp
...
sys%natins%bands(1)=91.0000000000000_dp
sys%natins%bands(2)=610.000000000000_dp
...
sys%natins%c4bands(1)=91.2500000000000_dp
sys%natins%c4bands(2)=610.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=11.0500000000000_dp
sys%chben%kid1xtr=5.45000000000000_dp
...
sys%ctc%kid=31.2500000000000_dp
 
!wtc
sys%wtc%Basic=30.1923076923077_dp
sys%wtc%CouLP=59.9038461538462_dp
sys%wtc%FT=12.3076923076923_dp
...
sys%incsup%MainCou=87.3000000000000_dp
sys%incsup%YngCou=66.5000000000000_dp
sys%incsup%MainLP=55.6500000000000_dp
sys%incsup%YngLP=33.5000000000000_dp
sys%incsup%MainSin=55.6500000000000_dp
sys%incsup%YngSin=44.0500000000000_dp
sys%incsup%ValFSM=4.34000000000000_dp
...
sys%ctax%bandD=22.1301923076923_dp
...
sys%rebatesys%MainCou=87.3000000000000_dp
sys%rebatesys%YngCou=66.5000000000000_dp
sys%rebatesys%MainLP=55.6500000000000_dp
sys%rebatesys%YngLP=44.0500000000000_dp
sys%rebatesys%MainSin=55.6500000000000_dp
sys%rebatesys%YngSin=44.0500000000000_dp
...
sys%rebatesys%PremFam=15.9500000000000_dp
...
sys%rebatesys%MaxCC1=135.000000000000_dp
sys%rebatesys%MaxCC2=200.000000000000_dp
...
sys%rebatesys%AddKid(1)=52.7500000000000_dp
sys%rebatesys%AddKid(2)=42.2700000000000_dp
