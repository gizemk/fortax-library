...
sys%inctax%pa=94.1346153846154_dp
...
sys%inctax%bands(1)=40.1923076923077_dp
sys%inctax%bands(2)=623.076923076923_dp
...
sys%natins%c2floor=83.8600000000000_dp
...
sys%natins%bands(1)=94.0000000000000_dp
sys%natins%bands(2)=630.000000000000_dp
...
sys%natins%c4bands(1)=94.1300000000000_dp
sys%natins%c4bands(2)=630.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=11.4000000000000_dp
sys%chben%kid1xtr=5.60000000000000_dp
...
sys%ctc%kid=32.5000000000000_dp
 
!wtc
sys%wtc%Basic=31.1538461538462_dp
sys%wtc%CouLP=61.8269230769231_dp
sys%wtc%FT=12.6923076923077_dp
...
sys%incsup%MainCou=88.1500000000000_dp
sys%incsup%YngCou=67.1500000000000_dp
sys%incsup%MainLP=56.2000000000000_dp
sys%incsup%YngLP=33.8500000000000_dp
sys%incsup%MainSin=56.2000000000000_dp
sys%incsup%YngSin=44.5000000000000_dp
sys%incsup%ValFSM=4.37000000000000_dp
...
sys%ctax%bandD=23.0142307692308_dp
...
sys%rebatesys%MainCou=88.1500000000000_dp
sys%rebatesys%YngCou=67.1500000000000_dp
sys%rebatesys%MainLP=56.2000000000000_dp
sys%rebatesys%YngLP=44.5000000000000_dp
sys%rebatesys%MainSin=56.2000000000000_dp
sys%rebatesys%YngSin=44.5000000000000_dp
...
sys%rebatesys%PremFam=16.1000000000000_dp
...
sys%rebatesys%AddKid(1)=54.3600000000000_dp
sys%rebatesys%AddKid(2)=43.8800000000000_dp
