...
sys%inctax%ctc=10.1730769230769_dp
sys%inctax%ctcyng=10.1730769230769_dp
...
sys%inctax%bands(1)=36.9230769230769_dp
sys%inctax%bands(2)=575.000000000000_dp
...
sys%natins%c2floor=77.4000000000000_dp
sys%natins%c2rate=2.00000000000000_dp
sys%natins%ceiling=585.000000000000_dp
...
sys%natins%bands(2)=585.000000000000_dp
...
sys%natins%c4bands(2)=585.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=10.5500000000000_dp
sys%chben%kid1xtr=5.20000000000000_dp
...
sys%fc%adult=60.0000000000000_dp
sys%fc%ftprem=11.6500000000000_dp
sys%fc%hours1=16.0000000000000_dp
sys%fc%hours2=30.0000000000000_dp
sys%fc%thres=94.5000000000000_dp
...
sys%fc%kidcred(1)=26.4500000000000_dp
sys%fc%kidcred(2)=26.4500000000000_dp
sys%fc%kidcred(3)=27.2000000000000_dp
sys%fc%kidcred(4)=27.2000000000000_dp
...
sys%incsup%MainCou=84.6500000000000_dp
sys%incsup%YngCou=64.4500000000000_dp
sys%incsup%MainLP=53.9500000000000_dp
sys%incsup%YngLP=32.5000000000000_dp
sys%incsup%MainSin=53.9500000000000_dp
sys%incsup%YngSin=42.7000000000000_dp
sys%incsup%ValFSM=4.27000000000000_dp
...
sys%incsup%PremFam=14.7500000000000_dp
...
sys%incsup%AddKid(1)=33.5000000000000_dp
sys%incsup%AddKid(2)=33.5000000000000_dp
sys%incsup%AddKid(3)=34.3000000000000_dp
sys%incsup%AddKid(4)=34.3000000000000_dp
 
!ctax
sys%ctax%docounciltax=.true. 
sys%ctax%bandD=18.5296153846154_dp
...
sys%rebatesys%MainCou=84.6500000000000_dp
sys%rebatesys%YngCou=64.4500000000000_dp
sys%rebatesys%MainLP=53.9500000000000_dp
sys%rebatesys%YngLP=42.7000000000000_dp
sys%rebatesys%MainSin=53.9500000000000_dp
sys%rebatesys%YngSin=42.7000000000000_dp
...
sys%rebatesys%PremFam=14.7500000000000_dp
...
sys%rebatesys%AddKid(1)=33.5000000000000_dp
sys%rebatesys%AddKid(2)=33.5000000000000_dp
sys%rebatesys%AddKid(3)=34.3000000000000_dp
sys%rebatesys%AddKid(4)=34.3000000000000_dp
