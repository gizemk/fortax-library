...
sys%fc%adult=62.5000000000000_dp
...
sys%incsup%AddKid(1)=37.0000000000000_dp
sys%incsup%AddKid(2)=37.0000000000000_dp
sys%incsup%AddKid(3)=37.8000000000000_dp
sys%incsup%AddKid(4)=37.8000000000000_dp
...
sys%rebatesys%AddKid(1)=37.0000000000000_dp
sys%rebatesys%AddKid(2)=37.0000000000000_dp
sys%rebatesys%AddKid(3)=37.8000000000000_dp
sys%rebatesys%AddKid(4)=37.8000000000000_dp
