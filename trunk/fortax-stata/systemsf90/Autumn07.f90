...
sys%inctax%pa=100.480769230769_dp
...
sys%inctax%bands(1)=42.8846153846154_dp
sys%inctax%bands(2)=665.384615384615_dp
...
sys%natins%c2floor=89.1300000000000_dp
sys%natins%c2rate=2.20000000000000_dp
...
sys%natins%bands(1)=100.000000000000_dp
sys%natins%bands(2)=670.000000000000_dp
...
sys%natins%c4bands(1)=100.480000000000_dp
sys%natins%c4bands(2)=670.000000000000_dp
sys%natins%c4bands(3)=1000000.00000000_dp
 
!chben
sys%chben%basic=12.1000000000000_dp
sys%chben%kid1xtr=6.00000000000000_dp
...
sys%ctc%kid=35.4807692307692_dp
 
!wtc
sys%wtc%Basic=33.2692307692308_dp
sys%wtc%CouLP=65.9615384615385_dp
sys%wtc%FT=13.5576923076923_dp
...
sys%incsup%MainCou=92.8000000000000_dp
sys%incsup%YngCou=70.7000000000000_dp
sys%incsup%MainLP=59.1500000000000_dp
sys%incsup%YngLP=35.6500000000000_dp
sys%incsup%MainSin=59.1500000000000_dp
sys%incsup%YngSin=46.8500000000000_dp
...
sys%ctax%bandD=25.0451923076923_dp
...
sys%rebatesys%MainCou=92.8000000000000_dp
sys%rebatesys%YngCou=70.7000000000000_dp
sys%rebatesys%MainLP=59.1500000000000_dp
sys%rebatesys%YngLP=46.8500000000000_dp
sys%rebatesys%MainSin=59.1500000000000_dp
sys%rebatesys%YngSin=46.8500000000000_dp
...
sys%rebatesys%PremFam=16.4300000000000_dp
...
sys%rebatesys%AddKid(1)=57.9500000000000_dp
sys%rebatesys%AddKid(2)=47.4500000000000_dp
